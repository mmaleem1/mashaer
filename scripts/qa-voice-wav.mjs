...
try {
  ...
  await page.waitForFunction(() => (
    window.__mashaer?.voiceCommands
    && document.getElementById('mashaer-voice-button')
  ), { timeout: 30_000 });
  ...
  const readState = () => page.evaluate(() => {
    ...
    return {
      ...
      voiceDetail: document.getElementById('mashaer-voice-detail')?.textContent?.trim() || null,
  ...
  await page.evaluate(() => document.getElementById('mashaer-voice-button').click());
