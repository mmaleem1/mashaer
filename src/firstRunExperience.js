...
export const FIRST_RUN_STORAGE_KEY = 'mashaer:first-run-mission:v1';
/** Per-session dismissal. Written by every close path; scoped to sessionStorage. */
export const FIRST_RUN_SESSION_KEY = 'mashaer:first-run-mission-session:v1';
 ...
 * Layer enablement IS durable in this app (`mashaer:layer-state:v2`, written by
 ...
 *   NOT TOUCHED           detection allocation (`mashaer:detection-allocation:v1`),
